  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'glass rounded-xl p-6 shadow-2xl data-[state=open]:animate-fade-in',
        className,
      )}
      {...props}
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md text-text-muted hover:text-text-primary transition-colors focus:outline-none">
          <X className="h-4 w-4" />
